      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                ...
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      ...
                      Contenidos prácticos y actualizados:{" "}
                    </dt>
                    <dd className="inline">
                      Aprendé habilidades que el mercado realmente busca, sin
                      perder tiempo en teoría innecesaria.
                    </dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      ...
                      Metodología de aprendizaje intensivo:{" "}
                    </dt>
                    <dd className="inline">
                      Clases breves, enfocadas y aplicables desde el primer día.
                    </dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                    ...
                    <dd className="inline">
                      Recibí feedback de expertos y construí un portfolio
                      profesional mientras estudiás.
                    </dd>
                  </div>
                </dl>
              </dl>
          ...
          <img
            ...
            className="w-full max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0 lg:w-[48rem] lg:h-auto lg:object-contain"
            width="2432"
            height="1442"
          />
        </div>
